...
const URLInicio = 'http://localhost:8804/api/consulta/pla-mod-desl-desm'
const cargaInicial = () => {
    fetch(URLInicio)
...
formRangoSeguro.addEventListener("submit",(e)=>{
    ...
    const URLRangoSeguro = `http://localhost:8804/api/consulta/entre-fechas-seguro/${inicialFecha}/${finalFecha}`;
...
formRangoModelo.addEventListener("submit",(e)=>{
    ...
    const URLRangoSeguro = `http://localhost:8804/api/consulta/entre-modelos/${inicialFecha}/${finalFecha}`;
...
const URLMaxModelo = 'http://localhost:8804/api/consulta/maxmodelo'
fetch(URLMaxModelo)
    .then(res => res.json())
    .then(data =>{
        console.log(data);
...
// Maximo modelo almacenado
const URLMinModelo = 'http://localhost:8804/api/consulta/minmodelo'
fetch(URLMinModelo)
    .then(res => res.json())
    .then(data =>{
        console.log(data);
    ...
    // Maximo modelo almacenado
const URLSumModelo = 'http://localhost:8804/api/consulta/suma-modelo'
fetch(URLSumModelo)
    .then(res => res.json())
    .then(data =>{
        console.log(data);
...
// Maximo modelo almacenado
const URLPromModelo = 'http://localhost:8804/api/consulta/prom-modelo'
fetch(URLPromModelo)
    .then(res => res.json())
    .then(data =>{
        console.log(data);
...
const URLLinea = 'http://localhost:8804/api/consulta/linea-activa-inactiva'
fetch(URLLinea)
    .then(res => res.json())
    .then(data =>{
        console.log(data);
